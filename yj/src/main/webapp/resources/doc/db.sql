...
DROP TABLE YJ_PLAN_PLACE CASCADE CONSTRAINTS; -- 
...
DROP SEQUENCE PLAN_PLACE_SEQ; -- 플랜 장소 시퀀스
...
CREATE TABLE YJ_PANO_DAY_REPLY (
	...
	PANO_DAY_REPLY VARCHAR2(4000),
	PANO_DAY_REPLY_WRITER NUMBER NOT NULL REFERENCES YJ_MEMBER(MEM_NO)
);

COMMENT ON TABLE YJ_PANO_DAY_REPLY IS '파노라마 일정 댓글 테이블';
COMMENT ON COLUMN "HR"."YJ_PANO_DAY_REPLY"."PONO_NO" IS '파노번호';
COMMENT ON COLUMN "HR"."YJ_PANO_DAY_REPLY"."PANO_DAY_NO" IS '파노데이번호';
COMMENT ON COLUMN "HR"."YJ_PANO_DAY_REPLY"."PANO_DAY_REPLY" IS '파노데이리플';
COMMENT ON COLUMN "HR"."YJ_PANO_DAY_REPLY"."PANO_DAY_REPLY_WRITER" IS '작성자 회원 번호';
...
COMMENT ON TABLE YJ_PLAN_DAY IS '플랜 장소 테이블';
COMMENT ON COLUMN "HR"."YJ_PLAN_PLACE"."PLAN_PLACE_NO" IS '플랜장소번호';
COMMENT ON COLUMN "HR"."YJ_PLAN_PLACE"."PLAN_DAY_NO" IS '플랜데이번호';
COMMENT ON COLUMN "HR"."YJ_PLAN_PLACE"."CONTENTID" IS '장소아이디';
CREATE SEQUENCE PLAN_PLACE_SEQ
    START WITH 1
    INCREMENT BY 1
;
