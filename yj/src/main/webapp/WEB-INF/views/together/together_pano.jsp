...
<div class="container">
	<ul class="nav nav-tabs content-tabs">
		<li class="active"><a href="together.do?type=pano">파노라마</a></li>
		<li class=""><a href="together.do?type=plan">일정</a></li>
	</ul>
	<div id="myTabContent" class="tab-content">
		<div class="tab-pane fade active in" id="pano">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<a href="panodetail.do?panoNo=${item.no }" class="thumbnail">
						<div class="thumbnail">
							<div class="caption">
								<h4>${item.day_memo }</h4>
								<p></p>
